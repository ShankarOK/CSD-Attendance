  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-8 px-4">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <form 
          ref={componentRef} 
          className={`bg-white print-container print-centered print-${printOrientation} shadow-2xl rounded-2xl border border-gray-200 overflow-hidden no-print-shadow`}
          role="document"
          ...
          <div className="print-table">
                      ...
                      <td className="print-td">
                        {isSaved && !isEditing ? (
                          <div className="flex items-center gap-2 no-print">
                            <span className="inline-flex items-center gap-1 px-3 py-1.5 bg-green-50 text-green-700 text-xs font-semibold rounded-lg border border-green-200 shadow-sm">
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs font-semibold rounded-lg border border-blue-200 shadow-sm transition-all duration-200 hover:shadow-md hover:scale-105 active:scale-95"
                              type="button"
                            >
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <button
                            ...
                            className={`px-4 py-2 text-white text-xs rounded-lg transition-all duration-200 font-semibold shadow-md hover:shadow-lg no-print flex items-center gap-1 ${
                              isEditing
            ...
            <div className="mt-6 flex justify-end no-print">
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
