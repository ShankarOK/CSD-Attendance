      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <button
            ...
            className="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-indigo-500 text-left"
          >
            <div className="p-8">
        ...
        <div className="max-w-4xl mx-auto mt-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-white rounded-xl shadow-md">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Easy Forms</h4>
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-md">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Print Ready</h4>
              <p className="text-sm text-gray-600">
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-md">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Database Driven</h4>
              <p className="text-sm text-gray-600">
